...
export const Blogs = ({ imageSrc, title, name, instructor, courseMode, btn, mode, tag, courseDuration, duration, venue, location }) => {
    return (
        <div className="max-w-lg h-[33rem] bg-white rounded-md overflow-hidden shadow-xl mt-4">
            ...
            <h1 className=' px-4 py-4 font-quicksand font-medium text-base text-xs '>{tag}</h1>
            <div className=' px-4'>
                <button
            ...
            <div className='flex flex-col text-sm align-center gap-4  justify-center pl-5 pr-5 '>
                <div className="flex lg:text-base text-xs font-quicksand  justify-between align-center gap-28">
                ...
                <div className="lg:text-base text-xs flex font-quicksand justify-between align-center gap-28">
                    <p className='flex items-center gap-2'>
    ...
    return (
        <div className=" bg-white overflow-hidden font-quicksand lg:mt-0  mt-8">
            ...
            <div className=' px-4 mt-6'>
                <button
                    className=" w-[10rem]  cursor-pointer lg:text-sm text-xs bg-primary text-white font-quicksand text-center rounded-sm p-2 text-md">
                    {course}
                </button>
            </div>
            <h1 className="font-bold px-4  mt-4 lg:text-2xl text-xl mb-2 ">{title}</h1>

            <div className='flex px-4 mt-4 text-sm align-center gap-2 '>
                <img className="" src={Pers} alt={title} />
                <p className="lg:text-base text-xs flex items-center lg:gap-2 gap-1 whitespace-nowrap">
                    <span className='font-semibold'> {role}: </span>
                    <span> {instructor}</span>
                </p>

                <p className="lg:text-base text-xs flex items-center whitespace-nowrap lg:gap-2 gap-1  lg:pl-32">
