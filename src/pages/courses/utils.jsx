...
export const CourseDetails = ({ imageSrc, title, mode, duration, venue }) => {
    ...
    return (
        <div className=" bg-white overflow-hidden font-quicksand lg:mt-0 mt-8 lg:w-full w-[95%] lg:pr-0 pr-2">
            ...
            <div className="grid shadow-lg border-gray-200 border-[1px] w-full lg:pr-12 rounded-md pb-12 lg:grid-cols-2 xl:grid-cols-2 grid-cols-1 xl:items-center xl:justify-between">
                {/* Left Column */}
